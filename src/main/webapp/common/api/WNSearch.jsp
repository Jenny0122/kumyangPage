    ...
    public class WNSearch {
        ...
        public String getPageLinks(int startCount, int totalCount, int viewListCount, int bundleCount) {
            ...
            if (wnanchor.getFirstPage() != -1) {
                sbRet.append("<a class=\"num right\" href=\"#none\" onClick=\"javascript:doPaging('" + wnanchor.getBundleBefore() + "');\" ><span class='ico_comm ico_prev'>이전</span></a>");
            } else {
                sbRet.append("<a class=\"num right\" href=\"#none\" ><span class='ico_comm ico_prev'>처음</span></a>");
            }
            ...
            for (int i = 0; i < pageCount && i < pages.length; i++) {
                if (pages[i][1].equals("-1")) {
                    sbRet.append("<strong class='num active' id='" + pages[i][0] + "'>" + pages[i][0] + "</strong>");
                } else {
                    sbRet.append("<a href=\"#none\" onClick=\"javascript:doPaging('" + pages[i][1] + "','" + pages[i][0] + "');\" class='num' id='P" + pages[i][0] + "'> " + pages[i][0] + " </a>");
                }
            }

            if (wnanchor.getBundleNext() != -1) {
                sbRet.append("<a class=\"num left\" href=\"#none\" onClick=\"javascript:doPaging('" + wnanchor.getBundleNext() + "')\" ><span class='ico_comm ico_next'>다음</span></a>");
            } else {
                sbRet.append("<a class=\"num left\" href=\"#none\" ><span class='ico_comm ico_end'>끝</span></a>");
            }
        ...
        public String getPageLinksWebAccess(String base, String url, int startCount, int totalCount, int viewListCount, int bundleCount) {
            ...
            if (wnanchor.getFirstPage() != -1) {
                sbRet.append("<A HREF='" + replaceURL(RequestURI, RequestURL, "startCount", String.valueOf(wnanchor.getFirstPage())) + "' class='num right'  ><span class='ico_comm ico_start'>처음</span></A>&nbsp;&nbsp;");
            } else {
                sbRet.append("<span class='ico_comm ico_start'>처음</span>&nbsp;");
            }
            if (wnanchor.getBundleBefore() != -1) {
                sbRet.append("<A HREF='" + replaceURL(RequestURI, RequestURL, "startCount", String.valueOf(wnanchor.getFirstPage())) + "' class='num right' ><span class='ico_comm ico_prev'>이전</span></A>&nbsp;&nbsp;");
            } else {
                sbRet.append("<span class='ico_comm ico_prev'>이전</span>&nbsp;");
            }
            ...
            for (int i = 0; i < pageCount && i < pages.length; i++) {
                if (pages[i][1].equals("-1")) {
                    sbRet.append("<b class='num'>" + pages[i][0] + "</b>");
                } else {
                    sbRet.append("<A HREF='" + replaceURL(RequestURI, RequestURL, "startCount", String.valueOf(pages[i][1])) + "' class='num'> " + pages[i][0] + " </A>");
                }
                /*if(pageCount > i+1) {
            ...
            if (wnanchor.getBundleNext() != -1) {
                sbRet.append("<A HREF='" + replaceURL(RequestURI, RequestURL, "startCount", String.valueOf(wnanchor.getBundleNext())) + "' class='num left'><span class='ico_comm ico_next'>다음</span></A>");
            } else {
                sbRet.append("&nbsp;&nbsp;<span class='ico_comm ico_next'>다음</span>");
            }
            if (wnanchor.getLastPage() != -1) {
                sbRet.append("&nbsp;&nbsp;<A HREF='" + replaceURL(RequestURI, RequestURL, "startCount", String.valueOf(wnanchor.getLastPage())) + "' class='num left'><span class='ico_comm ico_end'>끝</span></A>");
            } else {
                sbRet.append("&nbsp;&nbsp;<span class='ico_comm ico_end'>끝</span>");
            }
            return sbRet.toString();
        }
